...
const leaveApplicationA = {
    employeeId: userId,
    reason: "PTO",
    fromDate: currentYear + "-11-2",
    toDate: currentYear + "-11-5",
    leaveType: "CL",
    leavePlanned: false,
    fromSpan: "FULL DAY",
    toSpan: "FIRST HALF"
...
const leaveApplicationB = {
    employeeId: userId,
    reason: "PTO",
    fromDate: currentYear + "-11-16",
    toDate: currentYear + "-11-17",
    leaveType: "CL",
    leavePlanned: false,
    fromSpan: "SECOND HALF",
    toSpan: "FULL DAY"
...
test('User apply for leave single second half day', async () => {
    ...
    const leaveApplicationSec = {
        employeeId: userId,
        reason: "Travelling",
        fromDate: currentYear + "-12-15",
        toDate: currentYear + "-12-15",
        leaveType: "CL",
        leavePlanned: true,
        fromSpan: "SECOND HALF",
        toSpan: "SECOND HALF"
